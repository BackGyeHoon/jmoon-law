                        ...
                        <div className="relative py-20 px-4 lg:p-20">
                            <div className="max-w-lg mx-auto text-center">
                                ...
                                <div className="p-4 bg-white rounded-lg flex flex-wrap max-w-md mx-auto wow animate__animated animate__fadeIn" data-wow-delay=".5s">
                                    ...
                                    <a href="https://booking.naver.com/booking/13/bizes/762538/items/4610027?area=bmp&service-target=map-pc" target="_blank" className="w-full md:w-auto py-4 px-8 text-xs text-white font-semibold leading-none default-btn rounded content-center">
                                        상담하기
                                    </a>
                                </div>
                            </div>
