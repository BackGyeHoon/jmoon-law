          ...
          <div className="px-3 pb-5">
            <div className="card-slider group">
              ...
              <div className="flex justify-between items-end">
                ...
                <div>
                  <Link href="#">
                    <a className="tracking-wide hover-up-2 mr-2 inline-block px-4 py-3 text-xs text-mainColor-600 font-semibold leading-none border border-blue-200 hover:border-blue-500 hover:text-white hover:bg-blue-500 rounded default-box-border">
                      View Details
                    </a>
                  </Link>
                </div>
